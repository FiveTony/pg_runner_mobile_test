...
//     preload ()
//     {
//         this.load.image('guide', './src/assets/sprites/test/640x960-guide.png');
//         this.load.image('bg', './src/assets/sprites/test/bigsky.png');
//         this.load.atlas('clouds', './src/assets/sprites/test/clouds.png', './src/assets/sprites/test/clouds.json');
//         this.load.image('sky', './src/assets/sprites/test/sky.png');
//         this.load.image('ground', './src/assets/sprites/test/platform.png');
//         this.load.image('star', './src/assets/sprites/test/star.png');
//         this.load.image('bomb', './src/assets/sprites/test/bomb.png');
//         this.load.spritesheet('dude', './src/assets/sprites/test/dude.png', { frameWidth: 32, frameHeight: 48 });
//     }
